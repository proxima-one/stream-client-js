...
export class Parsing {
  public static parseProperty(obj: unknown, prop: string): unknown {
    if (Parsing.checkKeyExists(obj, prop)) return obj[prop];
  ...
  public static parsePropertyOrNull(
    obj: unknown,
    prop: string
  ): unknown | undefined {
    if (!Parsing.checkKeyExists(obj, prop)) return undefined;
  ...
  public static parseArrayPropertyOrEmpty(
    obj: unknown,
    prop: string
  ): unknown[] {
    if (!Parsing.checkKeyExists(obj, prop)) return [];
    const result = Parsing.parseProperty(obj, prop);
    return Parsing.parseArray(result);
  }
  ...
  public static parseNumberOrNullProperty(
    obj: unknown,
    prop: string
  ): number | undefined {
    if (!Parsing.checkKeyExists(obj, prop)) return undefined;
  ...
  public static parseHashMapProperty<T>(
    obj: unknown,
    prop: string,
  ...
  public static parseHashMap<T>(
    ...
    if (typeof hashMap === "object" && hashMap !== null)
      Object.entries(hashMap).forEach(
        ([key, value]) => (ret[key] = parser(value))
      );

    return ret;
  }

  public static parseHashMapPropertyProfiles<T>(
    obj: unknown,
    prop: string,
    parser: (item: unknown) => T
  ): Record<string, T> {
    ...
    if (typeof hashMap === "object" && hashMap !== null)
      Object.entries(hashMap).forEach(
        ([key, value]) => (ret[_.lowerFirst(key)] = parser(value))
      );

    return ret;
  }

  public static parseMapProperty<U, T>(
    obj: unknown,
    prop: string,
    keyParser: (item: unknown) => U,
    parser: (item: unknown) => T
  ): Map<U, T> {
    ...
    if (typeof hashMap === "object" && hashMap !== null)
      Object.entries(hashMap).forEach(([key, value]) =>
        ret.set(keyParser(key), parser(value))
      );
  ...
  public static parseStringOrNullProperty(
    obj: unknown,
    prop: string
  ): string | undefined {
    if (!Parsing.checkKeyExists(obj, prop)) return undefined;
  ...
  public static parseString(obj: unknown): string {
    if (typeof obj !== "string")
      throw new DTOParsingError(
        `Object is of wrong type, expected: string, got: ${typeof obj}`
      );
  ...
  public static parseBoolOrNullProperty(
    obj: unknown,
    prop: string
  ): boolean | undefined {
    if (!Parsing.checkKeyExists(obj, prop)) return undefined;
  ...
  public static checkKeyExists<Y extends PropertyKey>(
    obj: unknown,
    prop: Y
