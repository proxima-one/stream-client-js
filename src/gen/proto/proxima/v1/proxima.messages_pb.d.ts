...
export class GetNextMessagesRequest extends jspb.Message { 
    ...
    static toObject(includeInstance: boolean, msg: GetNextMessagesRequest): GetNextMessagesRequest.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: GetNextMessagesRequest, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): GetNextMessagesRequest;
    static deserializeBinaryFromReader(message: GetNextMessagesRequest, reader: jspb.BinaryReader): GetNextMessagesRequest;
}
...
export class GetNextMessagesResponse extends jspb.Message { 
    ...
    static toObject(includeInstance: boolean, msg: GetNextMessagesResponse): GetNextMessagesResponse.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: GetNextMessagesResponse, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): GetNextMessagesResponse;
    static deserializeBinaryFromReader(message: GetNextMessagesResponse, reader: jspb.BinaryReader): GetNextMessagesResponse;
}
