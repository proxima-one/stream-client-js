...
export class ProducerState extends jspb.Message { 
    ...
    setInputStreamsList(value: Array<model_v1_model_pb.StreamStateRef>): ProducerState;
    addInputStreams(value?: model_v1_model_pb.StreamStateRef, index?: number): model_v1_model_pb.StreamStateRef;
    clearOutputStreamsList(): void;
    getOutputStreamsList(): Array<model_v1_model_pb.StreamStateRef>;
    setOutputStreamsList(value: Array<model_v1_model_pb.StreamStateRef>): ProducerState;
    addOutputStreams(value?: model_v1_model_pb.StreamStateRef, index?: number): model_v1_model_pb.StreamStateRef;
    ...
    static toObject(includeInstance: boolean, msg: ProducerState): ProducerState.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: ProducerState, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): ProducerState;
    static deserializeBinaryFromReader(message: ProducerState, reader: jspb.BinaryReader): ProducerState;
}
...
export class StreamEvents extends jspb.Message { 
    ...
    addEvents(value?: model_v1_model_pb.Event, index?: number): model_v1_model_pb.Event;
...
export class GetProducerRequest extends jspb.Message { 
    ...
    static toObject(includeInstance: boolean, msg: GetProducerRequest): GetProducerRequest.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: GetProducerRequest, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): GetProducerRequest;
    static deserializeBinaryFromReader(message: GetProducerRequest, reader: jspb.BinaryReader): GetProducerRequest;
}
...
export class GetProducerResponse extends jspb.Message { 
    ...
    static toObject(includeInstance: boolean, msg: GetProducerResponse): GetProducerResponse.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: GetProducerResponse, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): GetProducerResponse;
    static deserializeBinaryFromReader(message: GetProducerResponse, reader: jspb.BinaryReader): GetProducerResponse;
}
...
export class ProduceEventsRequest extends jspb.Message { 
    ...
    static toObject(includeInstance: boolean, msg: ProduceEventsRequest): ProduceEventsRequest.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: ProduceEventsRequest, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): ProduceEventsRequest;
    static deserializeBinaryFromReader(message: ProduceEventsRequest, reader: jspb.BinaryReader): ProduceEventsRequest;
}
...
export class ProduceEventsResponse extends jspb.Message { 
    ...
    static toObject(includeInstance: boolean, msg: ProduceEventsResponse): ProduceEventsResponse.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: ProduceEventsResponse, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): ProduceEventsResponse;
    static deserializeBinaryFromReader(message: ProduceEventsResponse, reader: jspb.BinaryReader): ProduceEventsResponse;
}
